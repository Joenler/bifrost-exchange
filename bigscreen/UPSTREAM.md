...
| -------------------------- | ------------------------------------ | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `package.json`             | `src/dashboard/package.json`         | `039e72b31854e67c71e8f72afff001ef25178e88`   | Name `arena-dashboard` → `bifrost-bigscreen`. Dropped Phase-10-only deps: `lightweight-charts`, `echarts`, `echarts-for-react`, `@tanstack/react-query`, `@tanstack/react-table`, `zustand`, `react-resizable-panels`. `preview` script gained `--host 0.0.0.0 --port 4173`. |
